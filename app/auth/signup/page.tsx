      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="card-glow border-primary/30">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-foreground/60">Create your Velocity study planner account</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-center text-sm text-foreground/60 mt-4">
              ...
              <Link href="/auth/login" className="text-secondary hover:text-secondary/80 font-medium transition-colors duration-300">
                Sign in
              </Link>
            </p>
          </CardContent>
